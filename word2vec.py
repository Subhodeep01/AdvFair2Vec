...
if __name__ == "__main__":
    ...
    monitor = TrainingMonitor(log_dir="runs/w2v_v1")
    
    print("\nStarting GPU Training with Monitoring...")
    
    EPOCHS = 75
    WARMUP_EPOCHS = 75 # Warmup epochs = epochs when training a normal word2vec model without debiasing
    ...
    for epoch in range(EPOCHS):
        ...
        }, filename=f"checkpoint_word2vec.pth.tar")

    export_embeddings(w2v_model, idx2word, filename="base_vectors.txt")
    monitor.close()
